    ...
    <nav class="col s12 z-depth-5">
        <div class="nav-wrapper black">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            <li><a class="navbtn" href="index.php">Login</a></li>
          </ul>
...
?>
		...
		<div id = "main">
				<div class="form-group well" style="position:relative;width:60%;left:20%; margin-top: 50px;">
					<strong style="font-size:150%"><center>Register User</center></strong><br><br>
...
if(isset($_POST['submit'])){
				...
				if($conn->query($query))
				{                      
					echo "<script> Materialize.toast('Added User successful!', 4000, 'rounded')</script>";
				}
				else
				{   
					echo "<script> Materialize.toast('Cannot Add User.. Please Try Again !', 4000, 'rounded')</script>";
				}
				}
				else{
